                ...
                if (($hora_fim <= $hora_inicio)) {
                    ...
                    try {
                        ...
                        if (!isset($affected_rows)) {
                            ...
                            $output = shell_exec("python ../email/enviar_email.py " . escapeshellarg('agendamentoadm') . " " . escapeshellarg($email_gestor_str) . " " . escapeshellarg($email_frota_str) . " " . escapeshellarg($dataInserida_str));
                            $output = trim($output);
